...
export const AuthCard = ({ children, title, subtitle, className = "" }: AuthCardProps) => {
  return (
    <div className={`w-full max-w-md bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-white/20 dark:border-gray-800 p-8 rounded-3xl shadow-2xl relative overflow-hidden transition-all duration-700 animate-in fade-in slide-in-from-bottom-8 ${className}`}>
