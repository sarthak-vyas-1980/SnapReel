  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="relative p-2 text-gray-500 hover:text-indigo-600 hover:bg-indigo-50 rounded-xl transition-all active:scale-95"
      >
        <svg
          className="w-6 h-6"
          fill="none"
      ...
      {/* Dropdown Panel */}
      {isOpen && (
        <div className="absolute right-0 mt-3 w-80 bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-200">
      ...
      {toast && (
        <div 
          className="fixed bottom-6 right-6 flex items-center gap-3 bg-white border border-gray-100 shadow-2xl rounded-2xl p-4 pr-6 min-w-[300px] animate-in slide-in-from-right duration-500 z-[100]"
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 truncate max-w-[200px]">{toast.message}</p>
          </div>
