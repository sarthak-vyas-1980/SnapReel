...
export async function getTranscriptData(
  ...
  const baseFlags = `--no-check-certificates --write-auto-sub --write-sub --sub-lang "en,hi" --sub-format vtt --skip-download --retries 5 --extractor-retries 3 --force-ipv4 --js-runtimes node --remote-components ejs:github --extractor-args "youtube:player_client=web" -o "${outputTemplate}"`;
